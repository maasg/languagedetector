...
if exist %APP_ENV_DIR%\%APP_NAME%-deps.jar move %APP_ENV_DIR%\%APP_NAME%.jar %APP_ENV_DIR%\%APP_NAME%-deps_%random%.jar

move %SOURCE_DIR%\target\scala-2.11\%APP_NAME%-assembly-%APP_VERSION%-deps.jar %APP_ENV_DIR%\%APP_NAME%-deps.jar
