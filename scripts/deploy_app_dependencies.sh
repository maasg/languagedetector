...
mkdir -p ${APP_ENV_DIR}
mv $SOURCE_DIR/target/scala-2.11/languagedetector-assembly-${APP_VERSION}-deps.jar ${APP_ENV_DIR}
ln -sfn ${APP_ENV_DIR}/languagedetector-assembly-${APP_VERSION}-deps.jar ${APP_ENV_DIR}/languagedetector-deps.jar
