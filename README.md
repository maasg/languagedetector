...
The language detector comes with a set of opinionated design principles and a lightweight framework that may help you in pushing your idea into production. In the following section the core pieces are explained.
